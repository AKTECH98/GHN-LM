...
class LanguageModelDataset(torch.utils.data.Dataset):
    """Dataset that yields Graph objects for language models."""
    
    def __init__(self, model_configs, device='cpu', is_train=True):
        """
        Args:
...
class LanguageModelLoader:
    ...
    @staticmethod
    def loader(model_configs, meta_batch_size=1, dense=True, device='cpu', num_workers=0):
        """
        ...
        """
        dataset = LanguageModelDataset(model_configs, device=device, is_train=True)
